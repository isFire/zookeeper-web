...
<div class="container-full1">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <nav class="navbar navbar-default navbar-fixed-bottom" role="navigation">
                <div>
                    ...
                    <#--						</#if>-->
                    <div class="collapse navbar-collapse  style=" margin-left: 35%;
                    ...
                    <#--&lt;#&ndash;									 <#if isLogin>&ndash;&gt;-->
                    <#--&lt;#&ndash;									 <a href="${base}/logout">注销</a>&ndash;&gt;-->
                    <#--&lt;#&ndash;									 <#else>&ndash;&gt;-->
                    <#--&lt;#&ndash;									 <a data-toggle="modal" data-target="#loginModal" href="#loginModal">登录</a>&ndash;&gt;-->
                    <#--&lt;#&ndash;									 </#if>&ndash;&gt;-->
                    <#--&lt;#&ndash;								</li>&ndash;&gt;-->
                    <#--							</ul>-->
                </div>
        ...
        <div class="page-header text-center">
            <a href="${base}" style="text-decoration : none"><h1>
        ...
        <div class="text-center">
            <ul class="breadcrumb span12">
                ...
                <li><a href="${base}/read/addr?cxnstr=${cxnstr!''}">${cxnstr!''}</a></li>
                <#assign pathAppend = "/">
                <#if pathList??>
                    <#list pathList as p>
                        <#assign pathAppend=pathAppend+p+"/">
                        <i class="icon-chevron-right"></i>
                        <li><a href="${base}/read/node?path=${pathAppend?substring(0,pathAppend?length-1)}">${p!''}</a>
                        </li>
                    </#list>
                </#if>
...
<div class="row clearfix">
        ...
        <table class="table table-bordered">
            <#if children?size gt 0>
                <#list children as c>
                    <tr>
                        <td>
                            <a href="${base}/read/node?path=${pathAppend?substring(0,pathAppend?length-1)}/${c}">${c}</a>
                        </td>
                    </tr>
                </#list>
            <#--						<#else>-->
            <#--						<div class="alert"><h3 class="text-danger text-center">有子节点</h3></div>-->
            </#if>
        </table>
    </div>
    <div class="col-md-4 column">
    ...
    <div class="col-md-4 column">
        <h3>节点数据<span class="label label-info fontsize11">${dataSize}</span></h3>
...
<div class="modal fade" id="createModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="${base}/op/create" method="POST" class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input class="form-control" required name="name" id="inputName"
                                   placeholder="Name of new node" type="text"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="textAreaData" class="col-lg-2 control-label">数据:</label>
                        <div class="col-lg-10">
                            <textarea class="form-control" rows="10" name="data" id="textAreaData"
                                      placeholder="Data of new node" rows="6"></textarea>
                        </div>
                    </div>
...
<div class="modal fade" id="editModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="${base}/op/edit" method="POST" class="form-horizontal">
                <div class="modal-body">
                    <div class="alert alert-info">编辑节点: <strong>${pathAppend}</strong></div>
                    <div class="form-group">
                        <label for="textAreaData" class="col-lg-2 control-label">数据:</label>
                        <div class="col-lg-10">
                            <textarea class="form-control" required rows="10" name="data" id="textAreaData"
                                      placeholder="Data of new node" rows="6">${data!''}</textarea>
                        </div>
                    </div>
...
<div class="modal fade" id="deleteModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="${base}/op/delete" method="POST" class="form-horizontal">
                <div class="modal-body">
...
<div class="modal fade" id="rmrModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="${base}/op/rmrdel" method="POST" class="form-horizontal">
                <div class="modal-body">
...
<div id="loginModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form col-md-12 center-block" action="${base}/login" method="POST">
                    <div class="form-group">
